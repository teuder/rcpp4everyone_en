...
* `// [[Rcpp::export]]`：The function defined just below this sentence will be accessible from R. You need to attach this sentence to every functions you want to use from R.

* `using namespace Rcpp;` : This sentence is optional. But if you did not write this sentence, you have to add prefix `Rcpp::` to specify classes and functions defined by Rcpp. (For example, `Rcpp::NumericVector`)

* `RETURN_TYPE FUNCTION_NAME(ARGMENT_TYPE ARGMENT){}`：You need to specify data types of functions and arguments.
