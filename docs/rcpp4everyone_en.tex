...
Since the contents described on the page of \href{140_dataframe.Rmd}{DataFrame} can be mostly valid for \texttt{List} if replacing \texttt{DataFrame} with \texttt{List}, please refer to that for details.
