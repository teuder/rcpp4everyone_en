...
The standard C++ `<algorithm>` and `<numeric>` header files provide various generic algorithms. As mentioned in [the chapter on iterators](310_iterator.html), many of C++ algorithm use iterators to specify the location and extent to which the algorithm is applied.
